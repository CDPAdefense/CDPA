...
# -------------------------------------------------
#       Conv2d-1             |   [batch_size, 32, 28, 28]  
#       MaxPool2d-2          |   [batch_size, 32, 14, 14]  
#       Conv2d-3             |   [batch_size, 64, 14, 14]  
#       MaxPool2d-4          |   [batch_size, 64, 7, 7]  
#       Linear-5             |   [batch_size, 512]  
#       Linear-6             |   [batch_size, num_classes]  
# -------------------------------------------------
...
class LeNet_5(nn.Module):
    ...
    def forward(self, x):
        ...
        self.feature = x.view(x.shape[0], -1)
        # self.feature = feature.clone()
        x = F.relu(self.fc1(self.feature))
