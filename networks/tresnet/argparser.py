...
parser.add_argument('--class_description_path', type=str, default='./oidv6-class-descriptions.csv') # /mnt/ex-ssd/Projects/CV/multi-label/PartialLabelingCSL/data/oidv6-class-descriptions.csv
